...
- 6 iş türü: B2B SaaS, B2C abonelik, mikro SaaS, API servis, mobil uygulama aboneliği ve üyelik sitesi
- Ay başı abone + yeni kazanım − churn ile ay sonu aktif abone modeli
- MRR, ARR, yeni MRR, churned MRR ve net yeni MRR
- App Store/platform ve ödeme sağlayıcı komisyonları
- Abone başı sunucu ve destek maliyeti
- CAC, LTV, LTV/CAC ve CAC geri ödeme süresi
- Başabaş abone sayısı ve başabaş MRR
- 12 aylık abone gelişimi ile nakit akışının birlikte gösterilmesi
- Churn, abone küçülmesi, LTV/CAC, CAC geri dönüşü ve altyapı maliyeti uyarıları
...
v0.5 test paketi ortak finans, şema, uygulama açılışı ve beş sektörün özel kabul testlerini kapsar.
...
- SaaS abone planında churn ve yeni kazanım her ay bir sonraki dönemin abone tabanına taşınır.
- LTV prototipte abone başı tekrarlayan katkının aylık churn oranına bölünmesiyle hesaplanır.
