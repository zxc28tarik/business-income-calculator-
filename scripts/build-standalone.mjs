...
<body>
<header class="topbar"><div><p class="eyebrow">BUSINESS INCOME CALCULATOR · TEK DOSYA · v0.22.0</p><h1 id="pageTitle">${sector.name} Finansal Fizibilite</h1><p id="pageSubtitle" class="subtitle">Çevrimdışı tek dosyalık sektör hesaplayıcısı.</p></div><div class="topbar-actions"><label class="project-picker" for="projectSelect"><span>Kayıt</span><select id="projectSelect"></select></label><button id="projectNewButton" class="secondary-button" type="button">Yeni</button><button id="projectRenameButton" class="secondary-button" type="button">Adlandır</button><button id="projectDuplicateButton" class="secondary-button" type="button">Kopyala</button><button id="portfolioButton" class="secondary-button" type="button" aria-expanded="false">Portföy</button><button id="backupExportButton" class="secondary-button" type="button">Yedek</button><button id="backupImportButton" class="secondary-button" type="button">İçe Aktar</button><input id="backupImportInput" type="file" accept="application/json,.json" hidden /><button id="exportCsvButton" class="secondary-button" type="button">CSV / Excel</button><button id="reportButton" class="secondary-button" type="button">Rapor / HTML</button><button id="trackingButton" class="secondary-button" type="button" aria-expanded="false">Gerçek Takip</button><button id="printButton" class="secondary-button" type="button">Yazdır / PDF</button><button id="resetButton" class="secondary-button" type="button">Varsayılanlara dön</button></div></header>
