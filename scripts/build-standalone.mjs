...
<body>
<header class="topbar"><div><p class="eyebrow">BUSINESS INCOME CALCULATOR · TEK DOSYA · v0.19.0</p><h1 id="pageTitle">${sector.name} Finansal Fizibilite</h1><p id="pageSubtitle" class="subtitle">Çevrimdışı tek dosyalık sektör hesaplayıcısı.</p></div><div class="topbar-actions"><button id="exportCsvButton" class="secondary-button" type="button">CSV / Excel</button><button id="printButton" class="secondary-button" type="button">Yazdır / PDF</button><button id="resetButton" class="secondary-button" type="button">Varsayılanlara dön</button></div></header>
